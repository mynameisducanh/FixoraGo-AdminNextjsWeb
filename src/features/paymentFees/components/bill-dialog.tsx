...
interface Props {
  ...
  currentRow: PaymentFeesInterface
}

export function BillDialog({ open, onOpenChange, currentRow }: Props) {
  ...
  const handleConfirm = async () => {
    try {
      ...
      const res = await revenueManagerApi.confirmBill(
        currentRow.id,
        payload
      )
      console.log(res)
